                    ...
                    <div class="grid_5 form">
                        <form action="" method="post">
                            <div class="prefix_1 grid_3 suffix_1 nomargin" id="formContent">
                                <h2><label for="fullname">Full Name</label></h2><input id="fullname" name="fullname" type="text" placeholder="Enter full name here" required="">

                                <h2><label for="email">Email Address</label></h2><input id="email" name="email" type="email" placeholder="Enter email address here" required="">

                                <h2><label for="company">Company Name</label></h2><input id="company" name="company" type="text" placeholder="Enter company name here">

                                <h2><label for="location">Where are you based?</label></h2><input id="location" name="location" type="text" placeholder="Enter location here" required="">

                                <h2><label for="details">Please supply more details relating to your query</label></h2>
                                <textarea id="details" name="details" required="" wrap="soft">
</textarea><input id="formSubmit" type="submit" name="submit" value="Send Email!"><br>
                                <br>
                            </div>
                        </form>
                    </div>
